...
function getInfoBasedOnScore(){
    if(totalScore() < 10){
        var score_info = "Você precisa tomar mais cuidado com a sua privacidade!";
    } else if(totalScore() > 10){
        var score_info = "Parabéns! Pela sua pontuação, você sabe lidar com alguns erros cometidos pela maioria das pessoas na Web!"
    }
